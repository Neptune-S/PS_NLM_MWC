...
#define mainUART_CONSOLE_STACK_SIZE       (configMINIMAL_STACK_SIZE * 2)
#define mainUART_CONSOLE_TASK_PRIORITY    (tskIDLE_PRIORITY + 1)
/*
 * Create the task that implements a command console using the USB virtual com
 * port driver for intput and output.
 */
void vUARTConsoleStart( uint16_t usStackSize, unsigned portBASE_TYPE uxPriority );
