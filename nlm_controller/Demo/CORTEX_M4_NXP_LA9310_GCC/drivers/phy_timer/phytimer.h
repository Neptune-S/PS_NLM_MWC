...
#define PHY_TIMER_PPS_OUT_SSB_DEF_PERIODICITY   20/* ms */

#define SSB_EXTRA_SYMBOL_TIME			72 /*us*/	
#define SSS_DECODING_DELAY                      20 /*us*/
#define SSB_4_SYMBOLS                           143 /*us*/
#define MBOX_DELAY                              10 /*us*/   
#define SSB_DURATION_SSS_MBOX_DELAY             ((SSS_DECODING_DELAY + SSB_4_SYMBOLS + MBOX_DELAY + SSB_EXTRA_SYMBOL_TIME)/1000) /*ms*/ //100 + 10 + 
#define PHY_TIMER_PPS_OUT_INIT 		        PHY_TIMER_PPS_OUT_SSB_DEF_PERIODICITY - SSB_DURATION_SSS_MBOX_DELAY	
